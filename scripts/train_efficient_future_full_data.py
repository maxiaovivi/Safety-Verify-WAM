    ...
    *,
    ...
    for step in range(1, steps + 1):
        ...
        if step == 1 or step % 25 == 0 or step == steps:
            ...
            print(
                json.dumps(
                    {"phase": "training", "mode": mode, "seed": seed, **progress}
                ),
                flush=True,
            )
    ...
    train_predictions = [
        ...
        for row, target, score in zip(train_records, train_target, train_score)
    ]
    (run_dir / "train_predictions.jsonl").write_text(
